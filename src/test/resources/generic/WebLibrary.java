 ...
 */
     ...
     * Mouseover action 
     */
    public static Boolean Mouseover_Action(String ObjectXpath)
    {			Boolean stepstatus = true;
 ...
 */
	public static Boolean isElementDisplayed(String ObjectXpath)
    {
        ...
        try
        {
        	if (Highlightelement)
        	gHighlight(ObjectXpath);
        	stepStatus = driver.findElement(By.xpath(ObjectXpath)).isDisplayed();
        }
        catch (Exception e)
        {
            stepStatus = false;
 ...
 */
	public static Boolean isElementEnabled(String ObjectXpath)
    {
        ...
        try
        {
        	if (Highlightelement)
        	gHighlight(ObjectXpath);
        	stepStatus = driver.findElement(By.xpath(ObjectXpath)).isEnabled();
        }
        catch (Exception e)
        {
            stepStatus = false;
 ...
 */
	public static Boolean isElementSelected(String ObjectXpath)
    {
        ...
        try
        {
        	if (Highlightelement)
        	gHighlight(ObjectXpath);
        	stepStatus = driver.findElement(By.xpath(ObjectXpath)).isSelected();
        }
        catch (Exception e)
        {
            stepStatus = false;
 ...
 */
	public static Boolean SelectOPtionByValue(String ObjectXpath,String Option)
	{
        ...
        try
        {
        	if (Highlightelement)
            Highlight(ObjectXpath);
        	ObjectXpath = ObjectXpath + "/option["+Option+"]";
 ...
 */
        public static void gHighlight(String ObjectXpath)
    	{
    		try
    		{
    		   ...
    		   for (int iCnt = 0; iCnt < 2; iCnt++) 
    		   {
    		         js.executeScript("arguments[0].style.border='solid 4px green'", element);
    		         Thread.sleep(200);
    		         js.executeScript("arguments[0].style.border=''", element);
    		         Thread.sleep(200);
    		   }
